...
def Database():
    global conn, cursor
    conn = sqlite3.connect("db_hospitallog.db")
    cursor = conn.cursor()
    cursor.execute("CREATE TABLE IF NOT EXISTS `hospitallog` (log_id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, username TEXT, password TEXT, firstname TEXT, lastname TEXT)")
